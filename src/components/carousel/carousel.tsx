    ...
    >
      <SwiperSlide>
        <Box pos={"relative"}>
          <Box display={"inline"}>
            <Img
              src="https://dec.neu.edu.vn/_next/image?url=%2Fbn1.png&w=3840&q=75"
              width={"100%"}
      ...
      <SwiperSlide>
        <Box pos={"relative"}>
          <Box display={"inline"}>
            <Img
              src="https://dec.neu.edu.vn/_next/image?url=%2Fbn2.png&w=3840&q=75"
              width={"100%"}
              height={{ base: "180px", md: "auto", lg: "auto" }}
            ></Img>
          </Box>
      ...
      <SwiperSlide>
        <Box pos={"relative"}>
          <Box display={"inline"}>
            <Img
              src="https://dec.neu.edu.vn/_next/image?url=%2Fbn3.png&w=3840&q=75"
              width={"100%"}
              height={{ base: "180px", md: "auto", lg: "auto" }}
            ></Img>
          </Box>
      ...
      <SwiperSlide>
        <Box pos={"relative"}>
          <Box display={"inline"}>
            <Img
              src="https://dec.neu.edu.vn/_next/image?url=%2Fbn4.png&w=3840&q=75"
              width={"100%"}
              height={{ base: "180px", md: "auto", lg: "auto" }}
            ></Img>
          </Box>
